...
urlpatterns = [
    ...
    path('users/<int:user_id>/follow/', views.toggle_follow_view, name='toggle_follow'),
    path('users/<int:user_id>/followers/', views.user_followers_view, name='user_followers'),
    path('users/<int:user_id>/followings/', views.user_followings_view, name='user_followings'),
